                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">Transfer Ekle</h4>
                            ...
                            <div class="table-responsive">
                                <form action="{{route('admin_transfer_store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <table>
                                        ...
                                        <tr><h4>KM Price: </h4><input style="width: 1000px" id="km_price" type="number" name="km_price" placeholder="KM Price"/></tr><br>
                                        <tr><h4>BASE Price: </h4><input style="width: 1000px" id="base_price" type="number" name="base_price" placeholder="BASE Price"/></tr><br>
